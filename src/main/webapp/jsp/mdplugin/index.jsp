...
<head lang="en">
    ...
    <meta charset="UTF-8">
    <link rel="stylesheet" href="${contextPath}/plugin/markdownplus/markdown-plus.min.css"/>
    <script src="${contextPath}/plugin/markdownplus/markdown-plus.min.js"/>
</head>
<body>
...
T3: 2014-01-02, 9d"></i>
 ...
 <div class="ui-layout-center">
        <div id="editor"></div> &lt;!&ndash; editor &ndash;&gt;
        <div class="remodal" id="emoji-modal" data-remodal-id="emoji-modal"> &lt;!&ndash; emoji modal &ndash;&gt;
        ...
        <div class="remodal" id="fa-modal" data-remodal-id="fa-modal"> &lt;!&ndash; Font Awesome modal &ndash;&gt;
        ...
        <div class="remodal" id="ion-modal" data-remodal-id="ion-modal"> &lt;!&ndash; Ionicons modal &ndash;&gt;
        ...
        <div class="remodal" id="preferences-modal" data-remodal-id="preferences-modal" data-remodal-options="closeOnEscape: false, closeOnCancel: false, closeOnOutsideClick: false"> &lt;!&ndash; Preferences modal &ndash;&gt;
        ...
        <div class="remodal" data-remodal-id="help-modal"> &lt;!&ndash; help modal &ndash;&gt;
            <img src="icon.png" width="64"/>
        ...
        <div class="remodal" data-remodal-id="about-modal"> &lt;!&ndash; about modal &ndash;&gt;
            <img src="icon.png" width="64"/>
